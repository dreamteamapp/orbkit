...
var OrbSceneContext = (0, import_react.createContext)(null);
OrbSceneContext.displayName = "OrbSceneContext";
function useOrbSceneContext() {
  return (0, import_react.useContext)(OrbSceneContext);
}
function useOrbSceneProvider({
  ...
  const nextOrbIndexRef = (0, import_react.useRef)(0);
  const orbConfigsRef = (0, import_react.useRef)(/* @__PURE__ */ new Map());
  const imperativeRendererRef = (0, import_react.useRef)(null);
  const registerOrb = (0, import_react.useCallback)(() => {
    const index = nextOrbIndexRef.current;
    nextOrbIndexRef.current += 1;
    return index;
  }, []);
  const syncToRenderer = (0, import_react.useCallback)(() => {
    const renderer2 = imperativeRendererRef.current;
    if (renderer2) {
      renderer2.setOrbs(Array.from(orbConfigsRef.current.values()));
    }
  }, []);
  const registerOrbConfig = (0, import_react.useCallback)(
    (id, config) => {
  ...
  const unregisterOrbConfig = (0, import_react.useCallback)(
    (id) => {
...
function Grain({ intensity = 0.35, className, style }) {
  ...
  const renderNoise = (0, import_react2.useCallback)(() => {
...
function Orb({
  ...
  const [orbIndex, setOrbIndex] = (0, import_react4.useState)(-1);
  const fallbackOrbIndex = (0, import_react4.useMemo)(() => {
    let hash = 0;
  ...
  const [animationProps, setAnimationProps] = (0, import_react4.useState)(null);
  (0, import_react4.useEffect)(() => {
  ...
  const animationStyle = (0, import_react4.useMemo)(() => {
  ...
  const [blobAnimProps, setBlobAnimProps] = (0, import_react4.useState)(null);
  (0, import_react4.useEffect)(() => {
  ...
  if (wavyEnabled) {
    ...
    const blobStyle = {
      ...
      borderRadius: "50%",
      // Initial circle, animation overrides this
      transition: interactiveEnabled ? "transform 0.2s ease-out" : void 0,
      willChange: interactiveEnabled ? "transform" : void 0,
      ...blobAnimStyle,
      ...style
    };
    if (driftEnabled) {
...
function OrbScene({
  ...
  const [resolvedRenderer, setResolvedRenderer] = (0, import_react5.useState)(
  ...
  const presetOrbs = presetData?.points.map((point, index) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
    Orb,
    {
      color: point.color,
  ...
  const isImperative = resolvedRenderer !== "css";
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(OrbSceneContext.Provider, { value: contextValue, children: (0, import_react5.createElement)(
    as,
    {
      ref: setRef,
    ...
    isImperative ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ImperativeScene, { rendererType: resolvedRenderer }) : null,
    presetOrbs,
    children,
    // CSS renderer handles grain via Grain overlay; imperative renderers handle it internally
    !isImperative && resolvedGrain > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Grain, { intensity: resolvedGrain }) : null
  ) });
}
