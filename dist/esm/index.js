...
function useOrbSceneProvider({
  ...
  const orbConfigsRef = useRef(/* @__PURE__ */ new Map());
...
function OrbScene({
  ...
  const [resolvedRenderer, setResolvedRenderer] = useState2(
  ...
  const presetOrbs = presetData?.points.map((point, index) => /* @__PURE__ */ jsx4(
    Orb,
    {
      color: point.color,
  ...
  const isImperative = resolvedRenderer !== "css";
  return /* @__PURE__ */ jsx4(OrbSceneContext.Provider, { value: contextValue, children: createElement(
    as,
    {
      ref: setRef,
    ...
    isImperative ? /* @__PURE__ */ jsx4(ImperativeScene, { rendererType: resolvedRenderer }) : null,
    presetOrbs,
    children,
    // CSS renderer handles grain via Grain overlay; imperative renderers handle it internally
    !isImperative && resolvedGrain > 0 ? /* @__PURE__ */ jsx4(Grain, { intensity: resolvedGrain }) : null
  ) });
}
export {
  Grain,
