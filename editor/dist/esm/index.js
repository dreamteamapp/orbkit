...
function PresetGallery({ dispatch }) {
  const presetEntries2 = Object.entries(presets);
  ...
  return /* @__PURE__ */ jsxs7("div", { className: "orbkit-editor-presets", children: [
    ...
    /* @__PURE__ */ jsx7("div", { className: "orbkit-editor-preset-grid", children: presetEntries2.map(([name, preset]) => /* @__PURE__ */ jsxs7(
      "button",
      {
        type: "button",
...
import { presets as presets2 } from "@dreamteamapp/orbkit";
...
function ColorPalette({ value, onChange, colors = DEFAULT_PALETTE }) {
  ...
  return /* @__PURE__ */ jsx10("div", { className: "orbkit-editor-palette", children: colors.map((c) => {
...
var presetEntries = Object.entries(presets2);
...
function OrbCompactEditor({
  ...
  const [state, dispatch] = useEditorState(value, defaultValue, onChange);
  const selectedOrb = useMemo2(
    () => state.selectedOrbId ? state.orbs.find((o) => o.id === state.selectedOrbId) : void 0,
    [state.selectedOrbId, state.orbs]
  );
  return /* @__PURE__ */ jsxs10("div", { className: className ? `orbkit-compact-editor ${className}` : "orbkit-compact-editor", children: [
    /* @__PURE__ */ jsxs10("section", { className: "orbkit-compact-editor-section", children: [
      /* @__PURE__ */ jsx11("h3", { className: "orbkit-editor-section-title", children: "Presets" }),
      /* @__PURE__ */ jsx11("div", { className: "orbkit-compact-editor-preset-row", children: presetEntries.map(([name, preset]) => /* @__PURE__ */ jsxs10(
        "button",
        {
          type: "button",
          ...
          style: { background: preset.backgroundColor },
          children: [
            preset.points.map((pt) => /* @__PURE__ */ jsx11(
              "span",
              {
                className: "orbkit-editor-preset-dot",
                style: {
            ...
            /* @__PURE__ */ jsx11("span", { className: "orbkit-compact-editor-preset-label", children: preset.label })
          ]
        },
        name
      )) })
    ...
    /* @__PURE__ */ jsxs10("section", { className: "orbkit-compact-editor-section", children: [
      /* @__PURE__ */ jsx11("h3", { className: "orbkit-editor-section-title", children: "Color Points" }),
      /* @__PURE__ */ jsx11("div", { className: "orbkit-compact-editor-canvas-wrap", children: /* @__PURE__ */ jsx11(CanvasPreview, { state, dispatch }) }),
      /* @__PURE__ */ jsxs10("div", { className: "orbkit-compact-editor-color-points-footer", children: [
        /* @__PURE__ */ jsx11("p", { className: "orbkit-compact-editor-caption", children: "Drag points to reposition" }),
        /* @__PURE__ */ jsxs10("label", { className: "orbkit-compact-editor-toggle", children: [
          /* @__PURE__ */ jsx11(
            "input",
            {
              type: "checkbox",
          ...
          /* @__PURE__ */ jsx11("span", { children: "Symmetry lock" })
        ] })
      ] })
    ] }),
    selectedOrb ? /* @__PURE__ */ jsxs10("section", { className: "orbkit-compact-editor-section", children: [
      /* @__PURE__ */ jsx11("h3", { className: "orbkit-editor-section-title", children: "Selected Point" }),
      /* @__PURE__ */ jsx11("label", { className: "orbkit-compact-editor-sublabel", htmlFor: "orbkit-compact-hex-input", children: "Color" }),
      /* @__PURE__ */ jsx11(
        ColorPalette,
        {
